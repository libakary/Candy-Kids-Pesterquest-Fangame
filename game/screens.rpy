...
style window:
    ...
    background Image("gui/textbox_pc.png", xalign=0.5, yalign=1.0)
...
## menus.
#so the little options at the bottom of the dialogue box, gotta reposition and change into imagebuttons
...
#so the first screen that shows. title screen
#should have buttons for credits and chumroll maybe?
...
define config.main_menu_music = "audio/main_menu.wav"
...
screen main_menu():
    ...
    vbox:
        ...
        #imagebutton: _("Start") action ShowMenu("volumes") #so id add a screen or smth that is "volumes" and it would instead be action ShowMenu("volumes")
        imagebutton:
             idle "gui/start_idle.png"
             hover "gui/start_hover.png"
             action ShowMenu("volumes")
        ...
        imagebutton:
             idle "gui/friends_idle.png"
             hover "gui/friends_hover.png"
             action ShowMenu("chumroll")

        imagebutton:
             idle "gui/credits_idle.png"
             hover "gui/credits_hover.png"
             action ShowMenu("credits")

        #pq doesnt have help on the main menu
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

            ## Help isn't necessary or relevant to mobile devices.
            textbutton _("Help") action ShowMenu("help")

        #pq doesnt have warnings on the main menu
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            imagebutton:
                 idle "gui/exit_idle.png"
                 hover "gui/exit_hover.png"
...
#so the screen accessible from main menu with the button Start. also accessible when pressing esc in game.
#replace start with volumes
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Volumes") action ShowMenu("volumes")

        textbutton _("Options") action ShowMenu("options")

        textbutton _("Chumroll") action ShowMenu("chumroll")
...
##
## Used to display selection of volumes.
## copied from about screen, need to edit, add imagemaps to everything and connect them to script files
...
screen volumes():
    ...
    ## screen.
    use game_menu(_("Volumes"), scroll="viewport"):

        style_prefix "volumes"

        hbox yalign 0.5 spacing 20:
            imagebutton:
                idle "gui/volumeselect_icon_blank.png"
                action Start("start")
            imagebutton:
                idle "gui/volumeselect_icon_blank.png"
                action Start("volume1")
...
## copied from pesterquest screen, needs text and formatting
## add correct credits lmao, used images, and also probably gio's links since i did use it as a base
...
screen credits():
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        vbox:
             ...
             text "HOMESTUCK: PESTERQUEST 2" color gui.accent_color size 48

             text "EXECUTIVE PRODUCERS" text_align 0.5 color gui.accent_color size 30

             hbox:
                 text "beep" text_align 0.0 min_width 440

             hbox:
                 text "boop" text_align 0.0 min_width 440

             text "PRODUCER" text_align 0.5 color gui.accent_color size 30

             hbox:
                 text "beeps" text_align 0.0 min_width 440

             text "DIRECTOR" text_align 0.5 color gui.accent_color size 30

             hbox:
                 text "HARLEY" text_align 0.0 min_width 440

             text "WRITERS" text_align 0.5 color gui.accent_color size 30

             hbox:
                 text "JUDE" text_align 0.0 min_width 440
                 text "Imode" text_align 1.0

             text "CHARACTER ARTISTS" text_align 0.5 color gui.accent_color size 30

             hbox:
                 text "RAMU" text_align 0.0 min_width 440
                 text "Harry, Imode" text_align 1.0

             text "BACKGROUND ARTISTS" text_align 0.5 color gui.accent_color size 30

             hbox:
                 text "CHERRY" text_align 0.0 min_width 440
             ...
             hbox:
                 text "boops" text_align 0.0 min_width 440

             text "MUSICIANS" text_align 0.5 color gui.accent_color size 30

             hbox:
                 text "RAMU" text_align 0.0 min_width 440
                 text "Menu Theme, {i}\"something something\"{/i}" text_align 1.0

             text "GAME DESIGN AND PROGRAMMING" text_align 0.5 color gui.accent_color size 30

             hbox:
                 text "KARU" text_align 0.0 min_width 440
                 text "Demo, Harry, Imode" text_align 1.0
...
## Warnings Screen ############################################################
##
## Shows volume warnings
## copied from about screen, needs text and formatting
...
##
## Shows achievments
## copied from about screen, needs text and formatting, imagemaps
...
screen chumroll():
    ...
    ## vbox child is then included inside the viewport inside the game_menu
    ## screen.
    use game_menu(_("Chumroll"), scroll="viewport"):

        style_prefix "chumroll"
